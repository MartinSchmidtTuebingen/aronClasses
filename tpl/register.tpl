<p>
<form action='index.php?cl=register&fnc=register' method='post' autocomplete='off'
...
<td>
		...
		<td>
        <label>Best&auml;tige Mailadresse</td><td> <input type='text' name='mailadressvalidation'placeholder='mustermensch@mustermail.de' required/></label></td></tr>
<tr>
<td>
  ...
  <tr>
<td>
        <label>Best&auml;tige Passwort</td><td><input type='password' name='passwordvalidation' placeholder='Passwort' required//></br></label></td></tr>
